...
# The VisualizationAgent is no longer needed and has been removed.
...
class OrchestratorAgent:
    ...
    async def run(self, prompt: str):
        ...
        for i, task in enumerate(plan.get("tasks", [])):
            ...
            # The VisualizationAgent block has been removed as it's not needed.
...
2.  `DataAnalysisAgent`: Answers a specific question about a data table by running analysis.
...
Example Plan Structure:
{
  "tasks": [
    ...
    {
      "agent": "DataAnalysisAgent",
      "goal": "Which is the earliest film that grossed over $1.5 billion?"
    }
  ]
}
"""
